    ...
    <BcModal aberto={aberto} onFechar={aoFecharModal}>
      <div className="mrs-wrap">
        ...
        <form className="mrs-form" onSubmit={aoEnviarFormulario} noValidate>
          ...
          <BcBotao type="submit" loading={loading}>Confirmar acesso</BcBotao>
          ...
          <BcBotao variant="ghost" onClick={aoFecharModal}>Cancelar</BcBotao>
        </form>
      </div>
    </BcModal>
  );
    ...
    return (
      <BcModal aberto={aberto} onFechar={aoFecharModal}>
        <div className="mrs-sucesso">
          ...
          <BcBotao onClick={aoFecharModal}>Ir para o login</BcBotao>
        </div>
      </BcModal>
    );
  }
        ...
        {passo === "identificador" && (
          <>
            ...
            <form className="mrs-form" onSubmit={aoEnviarIdentificadorRecuperacao} noValidate>
              ...
              />
              <BcBotao type="submit" loading={loading}>Enviar código</BcBotao>
              <BcBotao variant="ghost" onClick={aoFecharModal}>Cancelar</BcBotao>
            </form>
          </>
        )}
        ...
        {passo === "codigo" && (
          <>
            ...
            <form className="mrs-form" onSubmit={aoVerificarCodigoRecuperacao} noValidate>
              ...
              />
              <BcBotao type="submit" loading={loading}>Verificar código</BcBotao>
              <BcBotao variant="ghost" onClick={() => { setPasso("identificador"); setErro(""); setCodigo(""); setEmailCompleto(""); }}>
                Voltar
              </BcBotao>
            </form>
          </>
        ...
        {passo === "nova-senha" && (
          <>
            ...
            <form className="mrs-form" onSubmit={aoDefinirNovaSenhaRecuperacao} noValidate>
              ...
              <BcBotao type="submit" loading={loading}>Salvar nova senha</BcBotao>
            </form>
          </>
        )}
      </div>
...
export default function PaginaLogin({ onLogin }) {
  const { toastProps, mostrarToast, fecharToast } = useBcNotificacao();
